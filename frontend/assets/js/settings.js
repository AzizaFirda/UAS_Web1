...
const Settings = {
    ...
    changePassword: async function(newPassword) {
        try {
            ...
            const response = await fetch('/backend/api/users.php?action=change-password', {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    uploadProfilePhoto: async function(file) {
        try {
            ...
            const response = await fetch('/backend/api/users.php?action=upload-photo', {
                method: 'POST',
                body: formData
            });
    ...
    applyLanguage: function(language) {
        ...
        showToast('Bahasa diupdate! Refresh halaman untuk melihat perubahan.', 'info');
    },
                ...
                confirmDialog(
                    ...
                    async () => {
                        try {
                            ...
                            const response = await fetch('/backend/api/users.php?action=clear-data', {
                                method: 'DELETE'
                            });
